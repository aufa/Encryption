...
<head>
  ...
  <title>Aufa Encryption Example</title>
  <style type="text/css">
  *,
  *:after,
  *:before {
...
<?php
        if (!empty($_POST['method']) && in_array($_POST['method'], array('decrypt', 'encrypt')) && !empty($_POST['value'])) {
          ...
          if ($_POST['method'] == 'decrypt') {
              $result = Aufa\Encryption\Encryption::decrypt($value, $key);
?>
...
if (extension_loaded('mcrypt')) {
           ...
           */
          $result = Aufa\Encryption\Encryption::encrypt($value, $key);
?>
...
<?php
           ...
           */
          $result = Aufa\Encryption\Encryption::altEncrypt($value, $key);
?>
